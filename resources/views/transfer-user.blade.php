                            ...
                            <form method="POST" action="{{ route('saveTransfer') }}">
                                ...
                                <div id="form">
                                    ...
                                    <div class="form-group" style="display: none;">
                                        ...
                                        <div class="col-md-12">
                                            <input id="mdate" autocomplete="off" placeholder="Date" type="date" class="form-control @error('mdate') is-invalid @enderror" name="mdate" value="<?php echo date('Y-m-d'); ?>" required autofocus>
