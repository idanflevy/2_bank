...
<body class=" ">
    ...
    <div class="nav-menu">
        ...
        <div class="items1">
            ...
            <div class="items2">
                <i class="fas fa-map-marker item-icon"></i>
                <a style="color: white;" href="#">
                    <p> LOCATION</p>
                </a>
            </div>
    ...
    <nav class="navbar navbar-expand-md navbar-dark  " id="banner" style="background-color: #3d5eab; color:white;">
        <div class="container">
            <!-- Brand -->
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="/">GROUP PROFILE</a>
                    </li>

                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="/login">CORPORATE GOVERNANCE</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="#">BUSSINESS ACTIVITIES</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="#">CHINA DESK</a>
                    </li>

                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="#">A COMMITED GROUP</a>
                    </li>

                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="#">MEDIA CENTER</a>
                    </li>

                    <li class="nav-item">
                        <a style="color: white;" class="nav-link" href="#">CAREER</a>
                    </li>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div style="position: absolute;">heloo</div>
