                            ...
                            <form method="POST" action="{{ route('saveWithdraw') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="amount" onkeypress="return isNumber(event)" autocomplete="off" min="1" placeholder="Enter amount to withdraw" step="0.1" type="number" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount') }}" required autofocus>
                                        @error('amount')
